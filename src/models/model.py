...
from .model_config import MiniChatConfig
...
class TransformerBlock(nn.Module):
    def __init__(self, layer_id: int, args: MiniChatConfig):
        super().__init__()
...
class MiniChat(PreTrainedModel):
    config_class = MiniChatConfig
    last_loss: Optional[torch.Tensor]

    def __init__(self, params: MiniChatConfig = None):
        super().__init__(params)
        if not params:
            params = MiniChatConfig()
        self.params = params
