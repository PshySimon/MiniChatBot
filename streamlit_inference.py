...
st.set_page_config(page_title="MiniChatBot-V1")
st.title("MiniChatBot-V1")

model_id = "/Users/caixiaomeng/Projects/Python/MiniChatBot/checkpoints"
...
def init_chat_messages():
    with st.chat_message("assistant", avatar="🤖"):
        st.markdown(
            "我是由cxm创建出来的mini chat bot，很高兴为您服务😄  \n"
